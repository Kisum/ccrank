...
export default function SetupPage() {
  ...
  const getCommand = () => {
    return `ccusage --json | curl -s -X POST "https://ccusageshare-leaderboard.vercel.app/api/sync?user=${encodeURIComponent(username)}&tz=$(date +%z)" -H "Content-Type: application/json" -d @-`;
  };
